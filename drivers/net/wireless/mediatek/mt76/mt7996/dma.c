...
int mt7996_dma_rro_init(struct mt7996_dev *dev)
{
	...
	/* ind cmd */
	mdev->q_rx[MT_RXQ_RRO_IND].flags = MT_QFLAG_WED | MT_RRO_Q_IND;
	...
	mdev->q_rx[MT_RXQ_MSDU_PAGE_BAND0].flags =
		MT_QFLAG_WED | MT_RRO_Q_MSDU_PG(0) | MT_QFLAG_RRO_EN;
	...
	if (mt7996_band_valid(dev, MT_BAND1)) {
		...
		mdev->q_rx[MT_RXQ_MSDU_PAGE_BAND1].flags =
			MT_QFLAG_WED | MT_RRO_Q_MSDU_PG(1) | MT_QFLAG_RRO_EN;
	...
	if (mt7996_band_valid(dev, MT_BAND2)) {
		...
		mdev->q_rx[MT_RXQ_MSDU_PAGE_BAND2].flags =
			MT_QFLAG_WED | MT_RRO_Q_MSDU_PG(2) | MT_QFLAG_RRO_EN;
...
int mt7996_dma_init(struct mt7996_dev *dev)
{
	...
	if (mtk_wed_device_active(wed) && mtk_wed_get_rx_capa(wed) &&
		...
		dev->mt76.q_rx[MT_RXQ_RRO_BAND0].flags =
			MT_QFLAG_WED | MT_RRO_Q_DATA(0) | MT_QFLAG_RRO_EN;
