...
{
	struct mt7921_dev *dev = container_of(work, struct mt7921_dev, reset_work);
	...
	set_bit(MT76_STATE_RESET, &dev->mphy.state);
	...
	clear_bit(MT76_STATE_RESET, &dev->mphy.state);
...
void mt7921_reset(struct mt76_dev *mdev)
{
	...
	if (!test_bit(MT76_STATE_RESET, &dev->mphy.state))
