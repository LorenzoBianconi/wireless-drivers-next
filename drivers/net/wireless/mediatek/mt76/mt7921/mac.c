...
static const struct mt7921_dfs_radar_spec etsi_radar_specs = {
...
static const struct mt7921_dfs_radar_spec fcc_radar_specs = {
	.pulse_th = { 110, -10, -80, 40, 5200, 128, 5200 },
	.radar_pattern = {
...
static const struct mt7921_dfs_radar_spec jp_radar_specs = {
	.pulse_th = { 110, -10, -80, 40, 5200, 128, 5200 },
	.radar_pattern = {
		[0] =  { 1, 0,  8,  32, 28, 0,  508, 3076,  13, 1,  1 },
		[1] =  { 1, 0, 12,  32, 28, 0,  140,  240,  17, 1,  1 },
...
static u16
mt7921_mac_tx_rate_val(struct mt76_phy *mphy, u8 mode, u8 rate_idx,
...
static void
mt7921_mac_write_txwi_tm(struct mt7921_dev *dev, struct mt76_phy *mphy,
			 __le32 *txwi, struct sk_buff *skb)
{
	...
	rateval = mt7921_mac_tx_rate_val(mphy, mode, td->tx_rate_idx,
			   ...
			   struct ieee80211_key_conf *key, bool beacon)
{
	...
	if (mt76_testmode_enabled(&dev->mt76))
		mt7921_mac_write_txwi_tm(dev, mphy, txwi, skb);
}
