...
mt76x2_sta_ps(struct mt76_dev *mdev, struct ieee80211_sta *sta, bool ps)
{
	...
	mt76xx_mac_wcid_set_drop(&dev->mt76, idx, ps);
}
...
const struct ieee80211_ops mt76x2_ops = {
	...
	.start = mt76x2_start,
	.stop = mt76x2_stop,
	.add_interface = mt76xx_add_interface,
	.remove_interface = mt76xx_remove_interface,
	.config = mt76x2_config,
	.configure_filter = mt76xx_configure_filter,
	.bss_info_changed = mt76x2_bss_info_changed,
	.sta_add = mt76xx_sta_add,
	.sta_remove = mt76xx_sta_remove,
	.set_key = mt76xx_set_key,
	.conf_tx = mt76xx_conf_tx,
