...
int mt76_connac_mcu_sta_ba(struct mt76_dev *dev, struct mt76_vif *mvif,
			   struct ieee80211_ampdu_params *params,
			   bool enable, bool tx);
int mt76_connac_mcu_uni_add_bss(struct mt76_phy *phy, struct ieee80211_vif *vif,
				struct ieee80211_sta *sta, bool enable);
int mt76_connac_mcu_add_sta_cmd(struct mt76_phy *phy, struct ieee80211_vif *vif,
				struct ieee80211_sta *sta, bool enable,
				int cmd);
static inline int
mt76_connac_mcu_uni_add_sta(struct mt76_phy *phy, struct ieee80211_vif *vif,
			    struct ieee80211_sta *sta, bool enable)
{
