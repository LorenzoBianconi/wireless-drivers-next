...
#define GET_DMASHDL_MIN_QUOTA_NUM(p) \
	(((p) & DMASHDL_MIN_QUOTA_MASK) >> MT_DMA_SHDL_MIN_QUOTA_OFFSET)

#define MT_DMA_SHDL_MAX_QUOTA_NUM(p) (((p) & 0xfff) << MT_DMA_SHDL_MAX_QUOTA_OFFSET)
#define GET_DMASHDL_MAX_QUOTA_NUM(p) \
	(((p) & DMASHDL_MAX_QUOTA_MASK) >> MT_DMA_SHDL_MAX_QUOTA_OFFSET)

#define PDMA_HIF_RST			MT_PDMA(0x100)
#define CONN_HIF_LOGIC_RST_N		BIT(4)

#define DMASHDL_OPTIONAL_CONTROL	MT_DMA_SHDL(0x008)
#define DMASHDL_PAGE_SETTING		MT_DMA_SHDL(0x00c)
#define GROUP_SEQUENCE_ORDER_TYPE	BIT(16)

#define DMASHDL_REFILL_CONTROL		MT_DMA_SHDL(0x010)
...
#define DMASHDL_GROUP0_CONTROL		MT_DMA_SHDL(0x020)
#define DMASHDL_GROUP1_CONTROL		MT_DMA_SHDL(0x024)
#define DMASHDL_GROUP2_CONTROL		MT_DMA_SHDL(0x028)
#define DMASHDL_GROUP3_CONTROL		MT_DMA_SHDL(0x02c)
#define DMASHDL_GROUP4_CONTROL		MT_DMA_SHDL(0x030)
#define DMASHDL_GROUP15_CONTROL		MT_DMA_SHDL(0x05c)
#define MIN_QUOTA			GENMASK(11, 0)
#define MAX_QUOTA			GENMASK(27, 16)

#define DMASHDL_SCHED_SETTING0		MT_DMA_SHDL(0x0b0)
#define DMASHDL_SCHED_SETTING1		MT_DMA_SHDL(0x0b4)

#define DMASHDL_QUEUE_MAPPING0		MT_DMA_SHDL(0x0d0)
#define DMASHDL_QUEUE_MAPPING1		MT_DMA_SHDL(0x0d4)
#define DMASHDL_QUEUE_MAPPING2		MT_DMA_SHDL(0x0d8)
#define DMASHDL_QUEUE_MAPPING3		MT_DMA_SHDL(0x0dc)
