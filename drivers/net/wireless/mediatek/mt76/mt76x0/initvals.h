...
static const struct mt76_reg_pair common_mac_reg_table[] = {
	...
	{ MT_MAC_SYS_CTRL,		0x00000000 }, /* 0x1004, , default Disable RX */
	{ MT_RX_FILTR_CFG,		0x00017f97 }, /* 0x1400  , RX filter control */
	{ MT_BKOFF_SLOT_CFG,		0x00000209 }, /* default set short slot time, CC_DELAY_TIME should be 2	 */
	...
	{ MT_TXOP_CTRL_CFG,		0x0000583f }, /*Extension channel backoff.*/
...
static const struct mt76_reg_pair mt76x0_mac_reg_table[] = {
	...
	/* Set rf_tx_pe deassert time to 1us */
