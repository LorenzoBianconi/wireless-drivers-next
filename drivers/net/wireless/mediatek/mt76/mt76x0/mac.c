...
struct mt76xx_tx_status mt76x0_mac_fetch_tx_status(struct mt76x0_dev *dev)
{
...
void mt76_send_tx_status(struct mt76x0_dev *dev, struct mt76xx_tx_status *stat, u8 *update)
{
...
void mt76x0_mac_set_ampdu_factor(struct mt76x0_dev *dev)
{
	...
	for (i = 0; i < ARRAY_SIZE(dev->mt76.wcid); i++) {
		...
		msta = container_of(wcid, struct mt76xx_sta, wcid);
...
static void
mt76x0_rx_monitor_beacon(struct mt76x0_dev *dev, struct mt76xx_rxwi *rxwi,
			  u16 rate, int rssi)
{
