...
#define MT_ARB_TQSW(n)			MT_ARB(0x100 + ((n) << 2))
#define MT_ARB_TQSM(n)			MT_ARB(0x110 + ((n) << 2))
#define MT_ARB_TQSM(n)			MT_ARB(0x110 + ((n) << 2))
#define MT_ARB_TQSE(n)			MT_ARB(0x118 + ((n) << 2))
#define MT_ARB_TQFW(n)			MT_ARB(0x120 + ((n) << 2))
#define MT_ARB_TQFM(n)			MT_ARB(0x130 + ((n) << 2))
#define MT_ARB_TQFE(n)			MT_ARB(0x138 + ((n) << 2))
